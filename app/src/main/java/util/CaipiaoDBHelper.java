...
public class CaipiaoDBHelper extends SQLiteOpenHelper {
    ...
    private static final String ADDNUMBERNEW = "add_number";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NEW_TOP + "(_id integer primary key autoincrement,h_g_p_name varchar(10),h_g_p_id varchar(30),h_g_p_cid varchar(30)" +
                ...
                ",h_g_p_max_bet_money varchar(30),h_g_p_max_bonus varchar(30),h_g_p_max_bonus_mode varchar(30),h_g_p_not_bet_code varchar(30)," +
                "h_g_p_singled_num varchar(30),h_g_p_singled_max_bonus varchar(30),title varchar(30))");

        db.execSQL("create table "+ADDNUMBERNEW+"(_id integer primary key autoincrement,nameId varchar(30),zero varchar(30),today_money varchar(30)," +
                "hx_name varchar(30),name varchar(30),number varchar(30),code_text varchar(30),multiple varchar(30)," +
                "mode varchar(30),money varchar(30),tid varchar(30),mount varchar(30),tipId varchar(30),idea varchar(30),time varchar(30))");
    }
